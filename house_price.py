...
with open("House.pkl",'rb')as f:
    model=pickle.load(f)
    #create function to accept rmng input and create an array
    ...
    if __name__ == "__main__":
        st.header("House Price Pretiction")
        ...
        Type=col1.selectbox("Select a Type",list(property_type_mapping.keys()))
